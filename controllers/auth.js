...
exports.login = asyncHandler(async (req, res, next) => {
    ...
    // Check for user, select method overrides default setting of 
    // password not being included in normal find query (as defined in User schema)
...
exports.forgotPassword = asyncHandler(async (req, res, next) => {
    ...
    try {
        ...
        res.status(200).json({
            success: true,
            data: resetUrl // resetUrl given in response
        });
